...
Item {
    ...
    readonly property string uk_santa_description: qsTr("Father Christmas traditionally flies over houses in England on an enchanted white horse, but if a white horse isn’t available, he may take a goat.")
    readonly property string netherlands_santa_name: qsTr("Sinterklaas")
    readonly property string netherlands: qsTr("Netherlands")
    readonly property string netherlands_santa_description: qsTr("Sinterklaas carries the big book that tells whether each child has been good or naughty in the past year. He traditionally rides a white horse.")
